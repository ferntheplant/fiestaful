...
export function generateInviteEmail(rsvps: { guest_email: string }[], eventDetails: { name: string; description?: string; date?: string; time?: string; location?: string }, eventUrl: string): string {
...
export function generateICSFile(eventDetails: { id: string; name: string; description?: string; location?: string; date?: string }): string {
  const startDate = eventDetails.date ? new Date(eventDetails.date) : new Date();
